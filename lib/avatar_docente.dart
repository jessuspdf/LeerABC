...
void main() {
  ...
  runApp(
      AvatarD(user: user)); // Pasas el mapa con los datos del usuario a MyApp.
}

class AvatarD extends StatelessWidget {
  final Map<String, dynamic> user;

  AvatarD({required this.user});
              ...
              Expanded(
                ...
                child: Container(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () => Navigator.push(context,
                        new MaterialPageRoute(builder: (context) => Ejemplo())),
                  ),
                ),
              ),
              Spacer(flex: 2),
